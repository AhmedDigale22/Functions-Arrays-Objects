...
// const inventory = ["item1", "item2", "item3", "item4", "item5"];
...
// Find the car with an id of 33
const car33 = inventory.find((inventory) => inventory.id === 33);

// Log the car's information

console.log(car33);

// for (let i of inventory) {
//   if (inventory.includes(i) && inventory.includes(i)) {
//     inventory.push(i);
//   }
// }
...
console.log(lastCar[0]);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console

const carModels = inventory.map((inventory) => inventory.car_model);

// Sort car models in alphabetical order
carModels.sort();
console.log(carModels);
// ==== Challenge 4 ====
// The accounting team needs all the years from every car on the lot. Create a new array from the dealer data containing only the car years and log the result in the console.
let carYears = inventory.map((inventory) => inventory.car_year);
...
const BMWAndAudi = inventory.filter(
  (car) => car.make === "BMW" || car.make === "Audi"
);
